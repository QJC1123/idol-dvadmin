...
urlpatterns = (
        [
            ...
            # path('api/', include('tosearchidol.urls')),
            path('api/', include('focusidol.urls')),
            path('api/', include('focuswork.urls')),
            path('api/', include('tvwork.urls')),
            path('api/', include('zywork.urls')),
            path('api/', include('idoltotal.urls')),
            # path('api/',include('tv.urls')),
            # path('api/',include('zy.urls'))
