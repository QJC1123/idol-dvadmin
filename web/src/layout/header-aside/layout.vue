<template>
  ...
  >
    ...
    <!-- 主体内容 -->
    <div class="d2-layout-header-aside-content" flex="dir:top" style="padding-bottom: 0;" >
      <!-- 顶栏 -->
      <div
      ...
      >
        <router-link
          ...
          flex-box="0"
        >
		<img src="../../../public/image/theme/d2/logo/logonew.png" style="height: 70%" />
		<!-- <img src="${$baseUrl}image/theme/${themeActiveSetting.name}/logo/logonew.png" /> -->
          <!-- <img
            v-if="asideCollapse"
      ...
      <div class="d2-theme-container" flex-box="1" flex >
        ...
        <div
		  ...
		  style="background-color: #fff;padding-top: 0;padding-right: 20px;color: #86909c;"
        >
          <d2-menu-side />
        </div>
        <!-- 主体 -->
