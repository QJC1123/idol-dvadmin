...
export default {
  ...
  computed: {
    ...mapState('d2admin', {
      // siteLogo: state => state.settings.data['login.site_logo'] || require('./image/logo.png'), // 网站logo地址
      ...
      loginBackground: state => state.settings.data['login.login_background'] || require('./image/bj01.png'), // 登录页背景图
...
<style lang="scss" scoped>
  ...
  .page-login {
    ...
    height: 100%;
    width: 100%;
    background-image: url(./image/bj01.png);
